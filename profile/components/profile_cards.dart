...
import 'profile_helpers.dart'; // 引入刚刚建好的 helper
    ...
    return Container(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          title: Text("Next of Kin (Emergency)", style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600, color: colors.primaryText)),
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(color: colors.cardAlt, borderRadius: BorderRadius.circular(12), border: Border.all(color: colors.borderColor)),
              child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
